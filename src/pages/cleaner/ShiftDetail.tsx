...
const MOCK_DETAILS: Record<string, MockShiftDetail> = {
  'shift-001': {
    ...
    status: 'completed', timeStart: '18:00', timeEnd: '22:15', duration: '4h 15m',
    leadSpecialist: 'Sarah Jenkins',
    zones: [
  ...
  'shift-002': {
    ...
    status: 'completed', timeStart: '14:00', timeEnd: '17:00', duration: '3h 00m',
    leadSpecialist: 'Sarah Jenkins',
    zones: [
  ...
  'shift-003': {
    ...
    status: 'incomplete', timeStart: '18:00', timeEnd: '22:15', duration: '4h 15m',
    leadSpecialist: 'Sarah Jenkins',
    zones: [
  ...
  'shift-004': {
    ...
    status: 'completed', timeStart: '07:30', timeEnd: '10:00', duration: '2h 30m',
    leadSpecialist: 'Sarah Jenkins',
    zones: [
...
function ZoneItem({ zone }: { zone: MockZone }) {
  const statusIcon = zone.status === 'completed'
    ? <CheckCircleIcon />
    : zone.status === 'incomplete'
    ? <XCircleIcon />
    : <SkipIcon />

  const statusLabel = zone.status === 'completed' ? 'Completed'
    : zone.status === 'incomplete' ? 'Incomplete'
    : 'Skipped'
    ...
    <div className="bg-white border border-[#E3E3DD] rounded-[12px] p-[17px] flex gap-4 items-start">
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-1">
        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="font-['Lato',sans-serif] font-bold text-[14px] tracking-[0.7px] text-[#434844] shrink-0 mt-1">
            {zone.time}
          </span>
        </div>
